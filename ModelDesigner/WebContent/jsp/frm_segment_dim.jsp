...
<frameset rows="36,*,0,0,0" frameborder="no" framespacing="0">
	<frame src="tab/cust_seg_dim_tab.jsp?&objSeq=<%=objSeq%>&objKind=<%=request.getParameter("objKind")%>" name="frm_tab" scrolling="no" noresize>
	...
	<frame src="help/cust_seg_dim_help.jsp" name="frm_main2" scrolling="yes" noresize>
