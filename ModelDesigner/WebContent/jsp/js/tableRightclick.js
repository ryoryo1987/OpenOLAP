...
//var newWin;
	...
	//	newWin.moveTo(500,300);
		...
		newWin = showModalDialog("cust_dim_member.jsp?key=-999",arrArgObjs,"status:false;dialogWidth:350px;dialogHeight:260px");
...
//	newWin.moveTo(500,300);
	var arrArgObjs = [window.document,parent.frames[1]];
	newWin = showModalDialog("cust_dim_member.jsp?key=" + selectedKey,arrArgObjs,"status:false;dialogWidth:350px;dialogHeight:260px");
