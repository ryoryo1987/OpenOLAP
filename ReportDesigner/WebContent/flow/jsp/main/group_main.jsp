...
<head>
	...
	<script language="JavaScript">
		...
		function regist(){
			...
			document.form_main.action="../hidden/group_regist.jsp";
...
<table class="Header">
	<tr>
		...
		<td class="HeaderTitleCenter">グループ</td>
...
<center>
	<iframe name="frm_inner" src="group_list.jsp" width="90%" height="460"></iframe>
</center>
	<div class="command">	
